  ...
  return (
    <div className=''>
      <Swiper
        ...
        <SwiperSlide>
          <div className="firstSlider p-[50px] md:p-[100px] lg:p-[150px] w-full">
            <div className="w-full md:w[80%] lg:w-[50%] mt-[30px] md:mt-0 lg:mt-0">
              ...
              <p className='text-sm lg:text-base'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Dolorem vitae quibusdam placeat dolores tempore optio error facere harum, corporis, voluptatibus dolor commodi sed non deleniti iusto voluptatum temporibus!</p>
              <div className="mt-5 hidden md:block lg:block xl:block">
        ...
        <SwiperSlide>
          <div className="secondSlider p-[50px] md:p-[100px] lg:p-[150px] w-full">
        ...
        <div className='absolute w-full flex justify-between px-1 md:px-10 lg:px-10 xl:px-10 top-[50%] translate-y-[-50%] z-10'>
